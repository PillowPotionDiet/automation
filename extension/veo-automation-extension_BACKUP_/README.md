# VEO Automation - Google Flow AI Extension
...
5. Select the `veo-automation-extension` folder
...
chrome --pack-extension=veo-automation-extension
```
...
1. **Get Source Code** - Contact original author or reverse-engineer
...
- **2.1.3.0** - Current extracted version
  - Side panel UI
  - Batch processing
  - Auto-download
...
(Contact author for license information)

---

## Support

For issues or questions, contact: **kylenguyenaws@gmail.com**
