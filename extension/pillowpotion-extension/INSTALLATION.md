...
## Install PillowPotion Extension in Chrome/Edge
...
2. Navigate to this folder: `pillowpotion-extension`
...
- Make sure you selected the `pillowpotion-extension` folder (not the parent `extension` folder)
...
2. Click **"Inspect views: service worker"** under PillowPotion
...
**Need Help?** Visit: https://automation.pillowpotion.com/public/
